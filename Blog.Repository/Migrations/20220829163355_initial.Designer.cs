...
namespace Blog.Repository.Migrations
{
    ...
    [Migration("20220829163355_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Core.Entities.Authentication.UserApp", b =>
                {
            ...
            modelBuilder.Entity("Blog.Core.Entities.Authentication.UserRefreshToken", b =>
                {
            ...
            modelBuilder.Entity("Blog.Core.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Blog.Core.Entities.Authentication.UserApp", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Blog.Core.Entities.Authentication.UserApp", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
